        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_exams_profile_TeacherId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    resultsOfExam = table.Column<float>(type: "real", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_examsResult_exams_examsId",
                        column: x => x.examsId,
                        principalTable: "exams",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_examsResult_profile_studentsID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    questionDegree = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_QAns", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QAns_exams_examsId",
                        column: x => x.examsId,
                        principalTable: "exams",
                        principalColumn: "id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_examsResult_examsId",
                table: "examsResult",
                column: "examsId");

            migrationBuilder.CreateIndex(
                name: "IX_examsResult_studentsID",
                table: "examsResult",
                column: "studentsID");

            migrationBuilder.CreateIndex(
                name: "IX_QAns_examsId",
                table: "QAns",
                column: "examsId");
        }
